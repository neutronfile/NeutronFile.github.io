...
miniWeather({
    ...
    success: function(w){
        ...
        document.getElementById('country').innerHTML = w.country;
        document.getElementById('weatherIcon').src = 'Stuff/' + IconSet + '/' + w.icon + '.png';
        document.getElementById('lowtemp').innerHTML = w.low + '&deg;' + temp.unit;
        document.getElementById('hightemp').innerHTML = w.high + '&deg;' + temp.unit;
    }
});
